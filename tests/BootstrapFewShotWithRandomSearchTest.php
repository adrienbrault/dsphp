...
use AdrienBrault\DsPhp\BootstrapFewShotWithRandomSearch;
...
final class BootstrapFewShotWithRandomSearchTest extends TestCase
{
    #[Test]
    ...
    #[Test]
    public function itPopulatesDemosOnBestCandidate(): void
    {
        $lm = $this->createLMStub("[[ ## answer ## ]]\nParis");
        $student = $this->createStudentModule($lm);
